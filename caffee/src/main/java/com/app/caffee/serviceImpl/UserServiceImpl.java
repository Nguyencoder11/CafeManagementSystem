...
import com.app.caffee.jwt.CustomerUserDetailsService;
import com.app.caffee.jwt.JwtFilter;
import com.app.caffee.jwt.JwtUtil;
import com.app.caffee.service.UserService;
import com.app.caffee.utils.CafeUtils;
import com.app.caffee.utils.EmailUtils;
        ...
        try {
            ...
            if (auth.isAuthenticated()) {
                if (customerUserDetailsService.getUserDetail().getStatus().equalsIgnoreCase("true")) {
                    ...
                    return new ResponseEntity<String>("{\"message\":\"" + "Wait for admin approved." + "\"}",
    ...
    public ResponseEntity<List<UserWrapper>> getAllUsers() {
        try {
            if (jwtFilter.isAdmin()) {
                return new ResponseEntity<>(userDao.getAllUsers(),
                        HttpStatus.OK);
            } else {
        ...
        try {
            if (jwtFilter.isAdmin()) {
                ...
                if (optional.isEmpty()) {
                    ...
                    CafeUtils.getResponseEntity("User id does not exit", HttpStatus.OK);
                }
            } else {
